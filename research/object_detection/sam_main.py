...
PATH_TO_LABELS = 'G:/Projets/Houssam/tensorflow_models/research/object_detection/data/snapshot_serengeti_label_map.pbtxt'
...
PATH_TO_TEST_IMAGES_DIR = pathlib.Path('G:/Projets/Houssam/tensorflow_models/research/object_detection/test_images/snapshot_serengeti')
TEST_IMAGE_PATHS = sorted(list(PATH_TO_TEST_IMAGES_DIR.glob("*.jpeg")))

test_data_json = 'G:/Projets/Houssam/tensorflow_models/research/object_detection/test_images/snapshot_serengeti/context_rcnn_demo_metadata.json'
